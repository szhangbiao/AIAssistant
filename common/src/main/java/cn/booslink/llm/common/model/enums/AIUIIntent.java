...
public enum AIUIIntent {
    ...
    KSONG_TOP("KSONG_TOP"),
    KSONG_TOP_SONG("KSONG_TOP_SONG"),
    KSONG_TOP_ARTIST("KSONG_TOP_ARTIST"),
    KSONG_ADD("KSONG_ADD"),
    KSONG_ADD_SONG("KSONG_ADD_SONG"),
    KSONG_ADD_ARTIST("KSONG_ADD_ARTIST"),
    ...
    KSONG_FULLSCREEN("KSONG_FULLSCREEN"),
